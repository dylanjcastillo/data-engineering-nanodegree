...
def process_song_file(cur, filepath):
    """Processes song metadata files to generate songs and artists tables
    ...
    filepath
        Input file path as specificed as string
    """
    # open song file
...
def process_log_file(cur, filepath):
    """Processes log files to generate time, users, and songplays tables
    ...
    t = df["ts"].apply(lambda ms: datetime.datetime.fromtimestamp(ms/1000.0))
